...
export const metadata: Metadata = {
  title: 'Oxycons — Icon library for the modern web',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body className={`${geist.variable} ${geistMono.variable} font-sans antialiased bg-[#0a0a0a] text-zinc-100 min-h-screen`}>
        <header className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-800/80 bg-[#0a0a0a]/90 backdrop-blur-sm">
          <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
            ...
            <nav className="flex items-center gap-8">
              <Link href="/icons" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors">
                Browse Icons
              </Link>
              <a
